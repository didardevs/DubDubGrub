            ...
            VStack {
                ZStack {
                    ...
                    HStack(spacing: 16) {
                        ...
                        VStack(spacing: 1) {
                            TextField("First Name", text: $viewModel.firstName).profileNameTextStyle()
                            TextField("Last Name", text: $viewModel.lastName).profileNameTextStyle()
                ...
                Button {
                    ...
                    DDGButton(buttonTitle: viewModel.profileContext == .create ? "Create Profile" : "Update Profile")
                }
                .padding(.bottom)
            }
